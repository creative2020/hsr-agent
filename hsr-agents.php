...
if ( $the_query->have_posts() ) {
	while ( $the_query->have_posts() ) {
		...
		$agent_office_name = get_post_meta($post->ID, "agent_office_name.post_title", true);
		...
		//
		$icon = "http://homespotrealty.com/wp-content/themes/genesis-hs/images/hsr-icon-med.png";
		$color = "#003764";
...
// display html
 		...
 		'<div class="agent-office-name">' . $agent_office_name . ' Office</div>'.
